...
export async function sendPaymentLinkEmail({
  ...
  <div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;max-width:560px;margin:0 auto;padding:24px;color:#18181b">
    ...
    <p style="margin:0 0 16px">You have a new invoice from ClearLedge.</p>
    ...
    <p style="margin:24px 0">
      <a href="${paymentUrl}" style="display:inline-block;background:#18181b;color:#fff;text-decoration:none;padding:12px 20px;border-radius:999px;font-weight:500">Pay invoice</a>
    </p>
