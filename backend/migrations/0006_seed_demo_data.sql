-- 0006: Demo seed for the redesigned frontend.
--
-- Applied via Supabase MCP on 2026-05-24. Wipes invoices, transactions,
-- proofs, audit_logs, and gmail_verifications (preserves gmail_tokens so the
-- SME's connected Gmail OAuth survives the reseed). Seeds 12 SEA SME
-- invoices spanning every status so the dashboard, charts, list filters,
-- detail tabs, and pipeline visualisation all have realistic data to render.
--
